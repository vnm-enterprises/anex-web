...
export function DashboardListingsClient({ listings: initialListings }: { listings: any[] }) {
    ...
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground font-medium">Manage and monitor all your property advertisements in one place.</p>
        </div>
      ...
      {listings.length === 0 ? (
        <div className="rounded-[3rem] border-dashed border-2 p-20 text-center bg-muted/20">
          ...
          <h2 className="text-3xl font-black tracking-tight mb-4">No listings yet</h2>
          <p className="max-w-md mx-auto text-muted-foreground font-medium mb-10">
            You haven&apos;t created any listings yet. Start reaching thousands of potential tenants today.
          </p>
          <Button asChild size="lg" className="rounded-2xl px-10 h-16 font-black text-lg">
